...
export default function PixPrivacidade() {
  ...
  useEffect(() => {
    ...
    if (synth) {
      ...
      const utter = new SpeechSynthesisUtterance(
        "Pix. Aqui você controla quem pode ver a chave Pix no seu perfil. A chave Pix é um código que as pessoas usam para te enviar dinheiro. Você pode escolher Todos, Meus contatos, Meus contatos exceto alguns, ou Ninguém. Clique na seta à sua esquerda acima para voltar."
      );
      utter.lang = "pt-BR";
      utter.rate = 0.85;
      synth.speak(utter);
    ...
    <PhoneFrame>
      <div className="h-full bg-white flex flex-col">
        ...
        <div className="bg-white px-4 py-3 border-b border-gray-200 flex items-center">
          ...
          <h1 className="text-xl font-semibold text-gray-900 ml-4">Pix</h1>
        </div>

        <div className="flex-1 overflow-y-auto p-4">
          <h3 className="text-sm text-gray-600 mb-4">Quem pode ver a chave Pix no meu perfil</h3>
